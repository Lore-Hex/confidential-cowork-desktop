...
export const PERMISSION_MODE_OPTIONS: Array<{
  ...
  },
  {
    ...
    description: 'TRCC will ask before file edits and shell commands that can change files.',
    tone: 'review',
  },
  {
    value: 'ask-commands',
    label: 'Ask before commands',
    description: 'TRCC will ask before running shell commands.',
    tone: 'command',
  },
  {
    value: 'trusted',
    label: 'Trusted',
    description: 'All TRCC tools are enabled for workflows you trust.',
    tone: 'trusted',
  },
]
...
export function getPermissionModeDescription(mode: PermissionMode): string {
  return (
    ...
    'TRCC will ask before file edits and shell commands that can change files.'
  )
}
